...
* [CVAT](https://github.com/cvat-ai/cvat) - Annotate better with CVAT, the industry-leading data engine for machine learning. Used and trusted by teams at any scale, for data of any scale.
* [Label Studio](https://github.com/HumanSignal/label-studio) - is a multi-type data labeling and annotation tool with standardized output format
